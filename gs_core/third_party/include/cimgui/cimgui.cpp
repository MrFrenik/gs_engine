...
//based on imgui.h file version "1.86 WIP" from Dear ImGui https://github.com/ocornut/imgui
...
CIMGUI_API bool igIsMouseTripleClicked(ImGuiMouseButton button)
{
    return ImGui::IsMouseTripleClicked(button);
}
